...
Current implementation status as of 2026-09-07: the 0.2 application API boundary is archived; 0.3 desktop security, 0.4 settings/local storage, and 0.5 ModelRuntime discovery are implemented on the active roadmap branch with their recorded evidence limits. The next product boundary to add is 0.6 runtime lifecycle.
